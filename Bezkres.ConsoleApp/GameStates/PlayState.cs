...
public class PlayState : IGameState
{
    ...
    private void LocalizationsInitalize()
    {
        ...
        Guid? pickaxe = _entityManager.GetItemByName("Kilof");
        if(pickaxe != null)
        {
    ...
    private void SystemRegistration()
    {
